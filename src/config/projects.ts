...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    displayName: 'MTS – Website HA Hardening',
    consultancy: 'MTS Consulting',
    status: 'current',
    timeline: 'In progress',
    summary: 'Hardening of the YAT public website cloud platform from its single-Availability-Zone pilot baseline to a highly available, multi-AZ deployment — removing the single-instance and single-AZ points of failure. Cloud infrastructure scope only — YAT Marketing retains the website content and CMS.',
    appearsIn: ['s1-cl3-at1'],
  },
  {
    slug: 'ledgerline-ha-hardening',
    displayName: 'MTS – Ledgerline HA Hardening',
    consultancy: 'MTS Consulting',
    status: 'current',
    timeline: 'In progress',
    summary: 'Hardening of the YAT Ledgerline (Accounting) cloud platform from its single-Availability-Zone baseline to a highly available, multi-AZ deployment. Cloud infrastructure scope only — YAT IT retains the application and data responsibilities.',
    appearsIn: ['s1-cl3-at1'],
  },
];
